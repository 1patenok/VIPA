...
('Смартфон iPhone', 70000, 'ACTIVE', 0, 2, 1, 'Мощный iPhone с большим экраном', 'Ул. Маяковского д.45', CURRENT_DATE),
...
('BMW X5', 2500000, 'ACTIVE', 0, 2, 3, 'Роскошный внедорожник с полным приводом', 'Ул. Севастопольская д.22', CURRENT_DATE);

-- Категория "Недвижимость" (category_id = 4)
INSERT INTO post (title, price, status, number_of_views, client_id, category_id, description, address, created_at)
VALUES
('Квартира в центре', 8000000, 'ACTIVE', 0, 2, 4, 'Просторная квартира с видом на парк', 'Ул. Ленина д.50', CURRENT_DATE),
...
('Детская кроватка', 8000, 'ACTIVE', 0, 2, 6, 'Кроватка с регулируемой высотой', 'Ул. Белинского д.8', CURRENT_DATE),
...
INSERT INTO post (title, price, status, number_of_views, client_id, category_id, description, address, created_at)
VALUES
('Учебник по математике', 500, 'ACTIVE', 0, 2, 8, 'Учебник для студентов и школьников', 'Ул. Университетская д.12', CURRENT_DATE),
